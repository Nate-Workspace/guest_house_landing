...
export function MasonryGallery({
  ...
  return (
    <div
      className={cn(
        "columns-1 gap-4 sm:columns-2 lg:columns-3 [&>button]:mb-4",
        className,
      )}
    >
        ...
        return (
          ...
          >
            <Image
              ...
              width={width}
              height={height}
              className="w-full h-auto object-cover transition-transform duration-700 ease-[cubic-bezier(0.25,0.1,0.25,1)] group-hover:scale-[1.02]"
